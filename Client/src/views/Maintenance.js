...
const maints = [
    {
        ...
        desc: "something random lorennn the industry's standard dummy text ever since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book it has?",
        expD: "12-12-12",
        hostel: "Hostel-H",
    },
    {
                ...
                {!maint && (
                    <Col sm="4">
                        <Card body>
                            ...
                            <CardText>
                                Everything is working fine, In case you run into
                                a problem report it to the authorities.
                            </CardText>
